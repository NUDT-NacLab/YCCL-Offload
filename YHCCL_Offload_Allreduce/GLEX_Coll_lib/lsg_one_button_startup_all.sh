...
#
#BRUCKf
module add mpi3-static
#module add mpi3-shared
export Rack_ID=cab50_59
#cab0_4
#cab0_4 
#cab0_4
#FT cab0_4
...
export EXCLUDE_NODE_LIST=cn114,cn43,cn2718,cn258,cn270,cn168,cn584,cn103,cn87,cn338,cn616,cn291
EXCLUDE_NODE_LIST_LENGTH=12
#24
...
case $MODE in
    ...
    7   )
        ...
        # exit
        yhbatch -M $Rack_ID -p $PARTITION  -N $Batch_NODEN --nodefile=nodefile.txt --time=0-0:15:20  ./batch-alltoall.sh
    ...
    10   )
        ...
        export  GLEX_COLL_NODEN_MAX=256
        export  GLEX_COLL_NODEN_MIN=256
        wait
    ...
    11   )
        ...
        wait
        # exit
        echo " yhbatch -M $Rack_ID -p $PARTITION -N $GLEX_COLL_NODEN_MAX --time=2-4:20:20  ./batch-allreduce.sh "
        yhbatch -M $Rack_ID -p $PARTITION  -N $GLEX_COLL_NODEN_MAX --time=2-4:20:20  ./batch-allreduce.sh
         ;;
    12   )
